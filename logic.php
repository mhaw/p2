...
//check for number entry between 1 and 20
if($numwords < 1 || $numwords > 20) {
	echo "Please enter a number between 1 and 20";
} else {
	//if number is valid proceed to pull random words, insert symbols and number 
	//if requested and concatenate final password
